...
class TemperaturaChart extends StatefulWidget {
  ...
  const TemperaturaChart({super.key, required this.client, required this.topic});

  @override
  _TemperatureAmbientChartState createState() => _TemperatureAmbientChartState();
}

class _TemperatureAmbientChartState extends State<TemperaturaChart> {
...
class _GaugePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Determinar el color basado en el valor de la temperatura ambiente
    Color needleColor;
    Color gaugeColor;
